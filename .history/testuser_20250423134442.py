...
create_user("Martin Mondaca", "admin@test.com", "admin", "admin123")
create_user("Líder Test", "leader@test.com", "leader", "leader123")
create_user("Colaborador Test", "collab@test.com", "participant", "collab123")
