...
from app.forms import AssignUserForm, LogHoursForm, LoginForm, RegistrationForm, ProjectForm, UpdateProgressForm, UpdateProjectStatusForm, Ta
...
def init_routes(app):
    ...
    def create_task(project_id):
        ...
        form = TaskForm()
        form.assigned_to_id.choices = [(u.id, u.name) for u in project.participants if u.role == 'participant']
