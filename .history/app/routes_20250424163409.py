...
def init_routes(app):
    ...
    project_status=project_status,            # dict: nombre -> estado
    project_dates=project_dates,              # dict: nombre -> obj con start_date y end_date
    project_progress=project_progress         # dict: nombre -> int
)
