...
class TaskForm(FlaskForm):
    name = StringField('Nombre de la Tarea', validators=[DataRequired()])
    description = TextAreaField('Descripción', validators=[Optional()])
    estimated_hours = FloatField('Horas Estimadas', validators=[Optional()])
    real_hours = FloatField('Horas Reales', validators=[Optional()])  # ✅ AGREGA ESTA LÍNEA
    ...
    assigned_to_id = SelectField('Asignar a', coerce=int, validators=[DataRequired()])
